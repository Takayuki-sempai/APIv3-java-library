...
import sendinblue.auth.Authentication;
import sendinblue.auth.HttpBasicAuth;
import sendinblue.auth.ApiKeyAuth;
import sendinblue.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("partner-key", new ApiKeyAuth("header", "partner-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sendinblue.com/v3
